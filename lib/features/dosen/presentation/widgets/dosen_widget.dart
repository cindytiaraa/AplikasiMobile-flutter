...
class DosenListView extends StatelessWidget {
  ...
  List<Color> _getGradientColors(int index) {
    final colors = [
      [const Color(0xFF7B68EE), const Color(0xFF8B7FD8)], // Purple
      [const Color(0xFFFF69B4), const Color(0xFFFF85D0)], // Pink
      [const Color(0xFF00BCD4), const Color(0xFF26E5FF)], // Cyan
